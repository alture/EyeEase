...
struct SampleData {
    ...
    [
        LensItem(name: "Secon Lense Yota 2", startDate: Date(), sphere: Sphere(left: -4.5, right: -4.25, proportional: false), isWearing: true, detail: LensDetail(baseCurve: "8.6", dia: "13", cylinder: "-2.75", axis: "90")),
